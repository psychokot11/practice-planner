...
function MainNav({ handleMenu }) {
  return (
    <ul>
      <li>
        <NavLink to="/dashboard" className={navLinkClasses} onClick={handleMenu}>
          <FcHome className={iconClasses} />
          <span>Home</span>
        </NavLink>
      </li>
      <li>
        <NavLink to="/plans" className={navLinkClasses} onClick={handleMenu}>
          <FcPlanner className={iconClasses} />
          <span>Plans</span>
        </NavLink>
      </li>
      <li>
        <NavLink to="/drills" className={navLinkClasses} onClick={handleMenu}>
          <FcIdea className={iconClasses} />
          <span>Drills</span>
        </NavLink>
      </li>
      <li>
        <NavLink to="/tags" className={navLinkClasses} onClick={handleMenu}>
          <FcFolder className={iconClasses} />
          <span>Tags</span>
        </NavLink>
      </li>
      <li>
        <NavLink to="/settings" className={navLinkClasses} onClick={handleMenu}>
